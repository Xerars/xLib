...
//Descript: Used to Define the Basic Data Type for the Project.
//Version : 1.0.6
...
//Float Express
typedef float               F32;              //32-Bit Float Point
typedef double              F64;              //64-Bit Float Point
typedef float               FLT32;            //32-Bit Float Point
typedef double              FLT64;            //64-Bit Float Point
typedef float               FLT;              //Float Point 
typedef double              DBL;              //Double Precision Float Point


//Character Express
typedef char                CHAR;             //Character
typedef char                xCHAR;            //Character
typedef const char          xCCHAR;           //Const Character


//Const Character Express
typedef char*               STR;              //String
typedef char*               xSTR;             //String
typedef const char*         CSTR;             //Const String
typedef const char*         xCSTR;            //Const String


#ifndef CCHAR       
  typedef const char        CCHAR;            //char
#endif    
